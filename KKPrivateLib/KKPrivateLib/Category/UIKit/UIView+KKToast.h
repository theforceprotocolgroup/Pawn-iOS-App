...
extern const NSString * kk_CSToastPositionTop;
extern const NSString * kk_CSToastPositionCenter;
extern const NSString * kk_CSToastPositionBottom;

@class kk_CSToastStyle;

@interface UIView (KKToast)
 ...
 */
- (UIView *)kk_toastViewForMessage:(NSString *)message
                              title:(NSString *)title
                              image:(UIImage *)image
                              style:(kk_CSToastStyle *)style;
...
/**
 `kk_CSToastStyle` instances define the look and feel for toast views created via the
 `makeToast:` methods as well for toast views created directly with
 `toastViewForMessage:title:image:style:`.
 
 @warning `kk_CSToastStyle` offers relatively simple styling options for the default
 toast view. If you require a toast view with more complex UI, it probably makes more
 sense to create your own custom UIView subclass and present it with the `showToast:`
 methods.
 */

@interface kk_CSToastStyle : NSObject
...
/**
 Creates a new instance of `kk_CSToastStyle` with all the default values set.
 */
- (instancetype)initWithDefaultStyle NS_DESIGNATED_INITIALIZER;

/**
 @warning Only the designated initializer should be used to create
 an instance of `kk_CSToastStyle`.
 */
 ...
 */
@interface kk_CSToastManager : NSObject
...
/**
 ...
 with with a nil style. By default, this is set to `kk_CSToastStyle`'s default
 style.
...
/**
 ...
 `kk_CSToastStyle`'s default style.
