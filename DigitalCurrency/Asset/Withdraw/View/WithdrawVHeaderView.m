...
@implementation WithdrawVHeaderView
...
-(UILabel *)countTitleLabel
{
    if (!_countTitleLabel) {
        ...
        _countTitleLabel.textColor = KKHexColor(435061);
        _countTitleLabel.text = @"可提现余额：";
    }
...
-(UILabel *)countLabel
{
    if (!_countLabel) {
        ...
        _countLabel.font = KKCNBFont(15);
        _countLabel.textColor = KKHexColor(FF7824);
    }
    return _countLabel;
}
