...
@implementation MyBorrowDetailCell
...
-(UILabel *)title
{
    if (!_title) {
        ...
        _title.preferredMaxLayoutWidth = 100;
    }
    return _title;
}
-(UILabel *)content
{
    if (!_content) {
        ...
        _content.preferredMaxLayoutWidth = SCREEN_WIDTH-30-100;
    }
    return _content;
}
